/* This is an implementation of a Randomized Prim's algorithm */
...
static void     push_cell_walls                 (MAZE maze, size_t cx, size_t cy);
static CELL_XY  get_random_cell_from_walllist   (MAZE maze);
static CELL_XY  get_rand_path_neighbour         (MAZE maze, CELL_XY cell);
static void     connect_cells                   (MAZE maze, CELL_XY wall_c, CELL_XY path_c);
